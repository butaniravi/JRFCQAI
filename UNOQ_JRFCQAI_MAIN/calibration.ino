...
void calibrate_compass(void) {
  ...
  /* The red LED will indicate that the compass calibration is active. */ 
  ...
  /* Stay in this loop until the transmitter pitch stick is lowered */
...
void calibrate_level(void) {
  ...
  /* Set gyro pitch/roll angles to the accelerometer pitch/roll angles at quadcopter startup */
