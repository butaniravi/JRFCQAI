...
void return_to_home(void) {
  ...
  if (flight_mode == 4) {
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    //Step 0: Perform some calculations before returning to home
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    if (return_to_home_step == 0) {
      //If the difference between aircraft's home coordinates and current coordinates is less than 90, start landing directly
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    //Step 1: Increase altitude to 20 meters above ground level
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    if (return_to_home_step == 1) {
      if (return_to_home_decrease <= 0)return_to_home_step = 2;
      if (return_to_home_decrease > 0) {
        pid_altitude_setpoint -= 0.02; // 0.035 default
        return_to_home_decrease -= 0.02; // 0.035 default
      }
    }
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    //Step 3: Start descending altitude
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    if (return_to_home_step == 3) {
      if (pid_altitude_setpoint > actual_pressure + 120)return_to_home_step = 4; // 150 default
      // Lower altitude by increasing pressure value
      pid_altitude_setpoint += 0.02; // 0.035 default
    }

    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    //Step 4: Turn off motors
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
