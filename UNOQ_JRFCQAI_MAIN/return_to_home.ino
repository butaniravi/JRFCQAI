...
void return_to_home(void) {
  ...
  if (flight_mode == 4) {
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    //Step 0: Perform calculations prior to returning home
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    if (return_to_home_step == 0) {
      //If the aircraft's home coordinate minus the current coordinate is less than 90, start landing directly
    ...
    if (return_to_home_step == 3) {
      ...
      // Lower altitude by increasing the air pressure setpoint
      pid_altitude_setpoint += 0.035;
    }
