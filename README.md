# 🚀 JRFCQAI: Dual-Brain Physical AI Flight Controller & Ground Station
...
* **Sensors (I2C4 QWIIC Port @ 400kHz):**
...
* **Actuators & Monitoring:**
  * **4x BLDC ESCs:** Driven at 350Hz on Hardware PWM Pins (`D3`, `D5`, `D7`, `D9`)
...
4. **Optimized 250Hz PID Execution Loop:** Implemented `k_yield()` and `k_waitus()` inside the main flight loop to guarantee a fixed 4ms (250Hz) execution cycle with ~3ms of spare processing headroom per loop.
